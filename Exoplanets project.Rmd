...
The terrestrial planets hug the x-axis, while the gas giants have higher mass.
This plot also shows that planets with only one planet in the system tend to 
